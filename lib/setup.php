 ...
 * Image sizes
 */
add_image_size( 'post-thumbnail', 750, 350, true );
...
function assets()
{
    ...
    wp_enqueue_style('sage/css', 'https://fonts.googleapis.com/css?family=Open+Sans:400,700|Raleway');
